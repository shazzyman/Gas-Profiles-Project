#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# This script calculates and visualizes the median gas density profiles for TNG100 and TNG300 simulations.
# It also plots the scatter across clusters for both simulations.
...
# TNG100 Results
# =============================================================================
# Load gas profiles from TNG100 simulation
...
# Calculate median density and radii
...
# Normalize radii by median R_Mean200
...
plt.semilogy(m_radii_norm, rho_vals[0], color="black", lw=0.5, alpha=0.25, label='individual clusters')

# Plot scatter region (16th to 84th percentiles)
...
for i in range(len(rho_vals)):
    ...
    plt.xscale("log")
    plt.semilogy(r_normalized_per, rho_vals_per, color="black", lw=0.5, alpha=0.25)
...
# TNG300 Results
# =============================================================================
# Load gas profiles from TNG300 simulation
...
ax = plt.subplot(111)
plt.xscale("log")
plt.semilogy(m_radii_norm, median_rho, color="#FF7F0E", lw=5, alpha=1, label='median TNG300 density')
plt.semilogy(m_radii_norm, rho_vals[0], color="black", lw=0.5, alpha=0.25, label='individual clusters')
...
# Comparison of TNG100 and TNG300
# =============================================================================
