...
def get_rho_norm(r, n0, rc, rs, a, B, epsilon, n02, rc2, B2):
    ...
    h_col = Vik_Cosmo.Ez(z) #Come back and investigate this
...
#MASS DERIVATION
#====================================================================================
# VOLUME = 4/3 * pi * R500 ^ 3 
# rho_c(z), R to M in collosus
# Integrate profile to obtain M500, which should be same as R to M
...
def mass_integral(cluster_name):
    ...
    r = cluster_dict[cluster_name][2]
    n0, rc, rs, a, B, epsilon, n02, rc2, B2 = (cluster_dict[cluster_name][3], cluster_dict[cluster_name][4], cluster_dict[cluster_name][5], 
